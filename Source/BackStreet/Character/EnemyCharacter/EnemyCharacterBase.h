...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FDelegateWidgetVisible, bool, Visibility);
...
public:
	...
	//적 HP 위젯 Visible 이벤트
	FDelegateWidgetVisible OnHpWidgetVisibleDelegate;
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Gameplay|UI")
		class UWidgetComponent* EnemyStatInfoWidget;
...
public:
	UFUNCTION()
		...
		virtual float TakeDebuffDamage(ECharacterDebuffType DebuffType, float DamageAmount, AActor* Causer) override;
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent)
		void InitEnemyStatInfoWidget();

	UFUNCTION(BlueprintNativeEvent)
		void InitTargetingSupportingWidget();

	UFUNCTION(BlueprintImplementableEvent)
		void InitStatInfoWidget();
