...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		UTexture2D* StageIcon = nullptr;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		UTexture2D* StageSubIcon = nullptr;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly )
		FItemInfoDataStruct MainRewardInfo;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		FItemInfoDataStruct SubRewardInfo;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		TArray<FItemInfoDataStruct> MainRewardInfoCandidateList;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		TArray<FItemInfoDataStruct> SubRewardInfoCandidateList;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		TArray<int32> EnemySpawnLocationIdxList;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		int32 MaxAreaIdx = -1; 

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		int32 CurrentAreaIdx = -1;
...
public:
	void ClearSpawnLocationInfo()
	{
		...
		EnemySpawnLocationIdxList.Empty();
...
//======= Reward  =======================
	...
	UPROPERTY(EditDefaultsOnly, Category = "Reward")
		TMap<EStageCategoryInfo, FStageRewardCandidateInfoList> StageSubRewardCandidateInfoMap;
