...
//
//	UFUNCTION(BlueprintCallable, BlueprintPure)
//		bool IsValidLevelForSkillUpgrade(FSkillStatStruct NewSkillInfo, uint8 TempSkillLevel);
//
//	UFUNCTION(BlueprintCallable, BlueprintPure)
//		uint8  GetSkillMaxLevel(int32 NewSkillID);
//
//	UFUNCTION(BlueprintCallable, BlueprintPure)
//	bool IsOwnMaterialEnoughForSkillUpgrade(FSkillStatStruct NewSkillInfo, uint8 TempSkillLevel);
//
//	UFUNCTION(BlueprintCallable, BlueprintPure)
//	TArray<uint8> GetRequiredMaterialAmount(FSkillStatStruct NewSkillInfo, uint8 TempSkillLevel);
//
//	UFUNCTION(BlueprintCallable, BlueprintPure)
