...
void ASkillBase::InitSkill(FSkillStatStruct NewSkillStat, USkillManagerComponentBase* NewSkillManagerComponent, FSkillInfo NewSkillInfo)
{
	...
	{
		FDelegateOnActionTrigger* deathDelegate = OwnerCharacterBaseRef->GetActionTriggerDelegate(ECharacterActionType::E_Die);
		if (deathDelegate)
		{
			deathDelegate->AddUObject(this, &ASkillBase::DeactivateSkill);
		}
	}
}
