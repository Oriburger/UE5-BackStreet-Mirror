...
public:
	...
	UFUNCTION(BlueprintCallable)
		void CacheGameData(FSaveSlotInfo NewSaveSlotInfo, FProgressSaveData NewProgressData, FAchievementSaveData NewAchievementData);

	UFUNCTION(BlueprintCallable, BlueprintPure)
		bool GetCachedSaveGameData(FSaveSlotInfo& OutSaveSlotInfo, FProgressSaveData& OutProgressData, FAchievementSaveData& OutAchievementData);
