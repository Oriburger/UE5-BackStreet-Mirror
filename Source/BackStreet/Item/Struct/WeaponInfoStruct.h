...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite)
		float StackAmount = 0.0f;

	FDebuffInfoStruct() : Type(ECharacterDebuffType::E_None), StackAmount(0.0f) {}
	FDebuffInfoStruct(ECharacterDebuffType NewType, float NewStackAmount)
		: Type(NewType), StackAmount(NewStackAmount) { }
};
